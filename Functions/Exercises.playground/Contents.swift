...
func combineLastCharacters(stringArray: [String]) -> String {
    var combinedLastCharacterString = ""
    
    for string in stringArray {
        if string.count > 0 {
            combinedLastCharacterString.append(string.last!)
        }
    }
    
    return combinedLastCharacterString
}

combineLastCharacters(stringArray: nonsenseArray)
//: __Problem 3__
//:
