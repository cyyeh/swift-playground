...
var secondDict = ["Anchovies": true, "Coconut": true, "Cilantro": false, "Liver": false]
...
if let Bo = presidentialPetsDict["Michele Obama"] {
    print("Michele Obama walks \(Bo) every morning.")
}
...
var albumsCount = studioAlbums.keys.filter({ $0.contains("Led Zeppelin") }).count
albumsCount
